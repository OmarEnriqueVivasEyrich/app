...
file_path = os.path.join(os.getcwd(), 'Org_Datos_Colombia.csv')
...
file_path2 = os.path.join(os.getcwd(), 'datos.csv')
df2 = cargar_datos(file_path2)

# Verificar las columnas disponibles en df2
st.write("Columnas en df2:", df2.columns.tolist())  # Mostrar las columnas disponibles

# Verificar si las columnas 'Sexo/Brecha de género' y 'Tipo de jornada' existen
if 'Sexo/Brecha de género' in df2.columns and 'Tipo de jornada' in df2.columns:
    # Filtrar Datos
    df_filtered = df2[
        (~df2['Sexo/Brecha de género'].str.contains('Cociente', case=False, na=False)) &
        (df2['Tipo de jornada'] != 'Total')
    ]
